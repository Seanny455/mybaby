...
function yes() {
    ...
    question.textContent = "Kisses my love"
    gif.src = 'AASETTS/SEAN.gif'
...
var gifs = ['AASETTS/hug-me-im-sad.gif', 'AASETTS/goma-peach.gif', 'AASSETTS/cash-app-empty.gif', 'AASSETTS/sad.gif', 'AASETTS/cry-cute.gif', 'AASETTS/reaction-sad.gif']
var noCount = 0
...
for (var i = 0; i < numbers; i++) {
    ...
    heart.src = 'AASETTS/Heart_corazón.svg.png';
    heart.alt = "Heart";
